...
const SCRATCH_DIR = "/Users/albertiano/.gemini/antigravity/brain/c35bdc15-8391-494c-8de0-190630cac49e/scratch/t024-r02-review";
...
console.log("AJV Draft 2020-12 validation result for Classifier T024 review r02:", valid);
if (!valid) {
  console.error("Validation errors:", JSON.stringify(validate.errors, null, 2));
  process.exit(1);
}

console.log("SUCCESS: Classifier T024 review r02 JSON strictly valid under Draft 2020-12!");
