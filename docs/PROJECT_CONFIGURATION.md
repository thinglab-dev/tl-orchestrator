...
seções `## Arquivos`, com SHA-256 e caminho relativo dos 26 arquivos; `## Integrações`, com
...
Os hashes de `## Arquivos` são gerados a partir dos 26 arquivos da revisão de origem já conferida
...
acompanhada, commit instalado, hashes dos 26 arquivos, destinos de skill, se cada destino é link
...
faz parte dos 26 arquivos distribuídos; não autoriza modelos nem precisa ser lida inteira por
...
apenas porque os 26 arquivos e hashes coincidem.
...
integração for versionada para a equipe, prefira uma cópia conferida dos 26 arquivos. Um link
...
carregado pertence a um destino registrado em `INSTALLATION.md` e compare os 26 arquivos com
...
3. prepare um plano que separe atualização dos 26 arquivos, migrações de `INSTALLATION.md` e
...
Depois das decisões, o Maker preserva modificações locais, instala os 26 arquivos de uma única
