#!/usr/bin/env python3
"""
classify_experimental_role.py
Invokes Classifier (agy gemini-3.8-flash-medium) to classify the experimental role
for Task T023 under Schema v3 (Minimum Sufficient Capability).
"""
...
BRIEFING_FILE = SCRATCH_DIR / "experimental-role-briefing.md"
RAW_OUT_FILE = SCRATCH_DIR / "experimental-role-raw.txt"
JSON_OUT_FILE = SCRATCH_DIR / "experimental-role-classification.json"
...
print(">>> Classification successfully validated!")
