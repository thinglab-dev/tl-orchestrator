...
next_action: Executar revisão independente r07 via OpenAI Codex (gpt-5.6-terra/high) em fresh session report-only.
coordinator:
  harness: claude
...
| T028 | gov | none | in_progress | [T027] | [] | 6 | evidence/T028-r01.md |
