#!/usr/bin/env python3
"""Dispatch independent Checker (OpenAI Codex gpt-5.6-terra / high) for T032+T033 r01."""
...
EVIDENCE_DIR = WORKSPACE_DIR / "_tl-orc" / "project" / "evidence" / "T032-T033-r01"
...
def main():
    ...
    print(f"Executing Codex Checker in {WORKSPACE_DIR}...")
