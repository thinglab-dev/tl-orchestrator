...
seções `## Arquivos`, com SHA-256 e caminho relativo dos 49 arquivos; `## Integrações`, com
...
Os hashes de `## Arquivos` são gerados a partir dos 49 arquivos da revisão de origem já conferida
...
acompanhada, commit instalado, hashes dos 49 arquivos, destinos de skill, se cada destino é link
...
faz parte dos 49 arquivos distribuídos; não autoriza modelos nem precisa ser lida inteira por
...
apenas porque os 49 arquivos e hashes coincidem.
...
integração for versionada para a equipe, prefira uma cópia conferida dos 49 arquivos. Um link
...
carregado pertence a um destino registrado em `INSTALLATION.md` e compare os 49 arquivos com
...
3. prepare um plano que separe atualização dos 49 arquivos, migrações de `INSTALLATION.md` e
...
Depois das decisões, o Maker preserva modificações locais, instala os 49 arquivos de uma única
