#!/usr/bin/env python3
"""Dispatch independent Checker (OpenAI Codex gpt-5.6-terra / high) for T032+T033 r03."""
...
EVIDENCE_DIR = WORKSPACE_DIR / "_tl-orc" / "project" / "evidence" / "T032-T033-r04"
...
def main():
    ...
    print(f"Executing Codex Checker (r03) in {WORKSPACE_DIR}...")
