...
seções `## Arquivos`, com SHA-256 e caminho relativo dos 28 arquivos; `## Integrações`, com
...
Os hashes de `## Arquivos` são gerados a partir dos 28 arquivos da revisão de origem já conferida
...
acompanhada, commit instalado, hashes dos 28 arquivos, destinos de skill, se cada destino é link
...
faz parte dos 28 arquivos distribuídos; não autoriza modelos nem precisa ser lida inteira por
...
apenas porque os 28 arquivos e hashes coincidem.
...
integração for versionada para a equipe, prefira uma cópia conferida dos 28 arquivos. Um link
...
carregado pertence a um destino registrado em `INSTALLATION.md` e compare os 28 arquivos com
...
3. prepare um plano que separe atualização dos 28 arquivos, migrações de `INSTALLATION.md` e
...
Depois das decisões, o Maker preserva modificações locais, instala os 28 arquivos de uma única
