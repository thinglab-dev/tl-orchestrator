...
next_action: Executar revisão independente r06 via OpenAI Codex (gpt-5.6-terra/high) em fresh session report-only.
coordinator:
  harness: claude
...
| T028 | gov | none | in_progress | [T027] | [] | 5 | evidence/T028-r01.md |
